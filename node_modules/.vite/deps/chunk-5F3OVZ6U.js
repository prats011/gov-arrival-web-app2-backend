...
function _toConsumableArray6(r) {
  return _arrayWithoutHoles6(r) || _iterableToArray7(r) || _unsupportedIterableToArray7(r) || _nonIterableSpread6();
}
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    getInk: function getInk(el) {
      return el && el.children ? _toConsumableArray7(el.children).find(function(child) {
    ...
    setSpacerSize: function setSpacerSize() {
      ...
      if (items) {
        ...
        var setProp = function setProp2(_name, _value, _size) {
          ...
          return _this6.spacerStyle = _objectSpread4(_objectSpread4({}, _this6.spacerStyle), _defineProperty7({}, "".concat(_name), (_value || []).length * _size + _cpos + "px"));
        };
        if (both) {
...
export {
  ...
  script8,
  script9,
  script11 as script10,
  script12 as script11,
  OverlayEventBus,
  script13 as script12,
  Ripple,
  script14 as script13
};
//# sourceMappingURL=chunk-5F3OVZ6U.js.map

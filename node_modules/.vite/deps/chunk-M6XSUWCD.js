...
function Lt2(e, t2) {
  b2(e) ? e.push(...t2 || []) : i(e) && Object.assign(e, t2);
}
function ve(e) {
...
function Dt(e = {}, t2) {
  if (p2(t2)) {
    let r = t2.trim();
    return z2(r, k3) ? r.replaceAll(k3, (s4) => F(e, s4.replace(/{|}/g, ""))) : r;
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    let a2 = { preset: s4 ? U2(S2.getPreset(), t2) : t2, options: i2 ? g3(g3({}, S2.getOptions()), r) : r };
...
//# sourceMappingURL=chunk-M6XSUWCD.js.map
